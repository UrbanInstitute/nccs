---
title: "Estimating the Nonprofit and Philanthropic Sector's Payroll Taxes, 2026, Using 2023 Data"
...
pc.2024.subset <- filter( pc.2024, year=="2023" )
pc.2023.subset <- filter( pc.2023, year=="2023" )
pf.2024.subset <- filter( pf.2024, year=="2023" )
pf.2023.subset <- filter( pf.2023, year=="2023" )
```
...
names(   pc.2024.subset2   )
head(   pc.2024.subset2   )
...
names(   pc.2023.subset2   )
head(   pc.2023.subset2   )

pf.2024.subset2 <- 
  pf.2024.subset %>%
  select( ein, compofficers, pensplemplbenf )

names(   pf.2024.subset2   )
head(   pf.2024.subset2   )

pf.2023.subset2 <- 
  pf.2023.subset %>%
  select( ein, compofficers, pensplemplbenf )

names(   pf.2023.subset2   )
head(   pf.2023.subset2   )
```
...
# January 2022 has the same buying power as $1.08 in December 2025, which is
# the latest available data.
( tax.total * 1.08 ) %>% dollarize()