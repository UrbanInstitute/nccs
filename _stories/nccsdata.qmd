...
In part 1 of this 4-part series on the [`nccsdata`](https://urbaninstitute.github.io/nccsdata/) package, we introduce the package and describe the process of downloading NCCS legacy data with the help of `get_data()`. Parts 2 to 4 cover NTEE codes, census data and summary tables respectively. 
