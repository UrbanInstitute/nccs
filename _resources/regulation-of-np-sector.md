...
categories:
  - survey
abstract: "The Regulation of Nonprofits and Philanthropy Project conducts research on the regulatory frameworks that govern the nonprofit sector with the goals of (1) systematically documenting current regulations across states, (2) developing research tools to access those regulations and promote research through the nonprofit Legal Compendium, (3) conducting research on regulation of nonprofits and philanthropy to deepen our understanding of how policies impact nonprofits, and (4) promoting the diffusion of research and best practices through publications and convenings."
primaryLinks:
...
pubs:
  - full-citation: 'Lott, Cindy M., Nathan Dietz, and Marcus Gaddy. State Regulation and Enforcement in the Charitable Sector. Washington, DC: Urban Institute, 2016.'
    href: https://www.urban.org/research/publication/state-regulation-and-enforcement-charitable-sector
    link-text: Report
  - full-citation: 'Lott, Cindy M., Nathan Dietz, and Marcus Gaddy. “Bifurcation of State Regulation of Charities.” Washington, DC: Urban Institute, 2018.' 
    href: 'https://www.urban.org/research/publication/bifurcation-state-regulation-charities' 
    link-text: Research Brief
  - full-citation: "Adelstein, Shirley, and Elizabeth T. Boris. “State Regulation of the Charitable Sector: Enforcement, Outreach, Structure, and Staffing.” Washington, DC: Urban Institute, 2018."
    href: "https://www.urban.org/research/publication/state-regulation-charitable-sector"
    link-text: Research Brief
  - full-citation: 'Pettijohn, Sarah L., and Elizabeth T. Boris. “Testing Nonprofit State Culture: Its Impact on the Health of the Nonprofit Sector.” Nonprofit Policy Forum 9, no. 3 (2018). https://doi.org/10.1515/npf-2018-0012.'
    href: 'https://doi.org/10.1515/npf-2018-0012'
    link-text: Journal Article
  - full-citation: 'Lott, Cindy M., Mary L. Shelly, Nathan Dietz, and George E. Mitchell. “The Regulatory Breadth Index: A New Tool for the Measurement and Comparison of State-Level Charity Regulation in the United States,” Nonprofit Management and Leadership 33, no. 3 (2022): 633–45. https://doi.org/10.1002/nml.21536.' 
  ...
  - full-citation: Legal Compendium - Version 3.0
    href: https://urbanorg.box.com/shared/static/xwje48psocj0zxz6titlz8t133eslr53.xlsx
    link-text: Dataset
---
...
Inaugurated with the first conference to convene state attorneys general, foundations, and nonprofit leaders, in 2006 Columbia University launched the Charities Regulatory and Oversight Project as part of the National State Attorney’s General Program. The conference and project were at the time supported by the Ford Foundation, C.S. Mott Foundation, New York Community Trust, and the Surdna Foundation. Hosting regular meetings and trainings for state charities officials, the project developed conferences with state and federal regulators, practitioners, and academics in attendance. In 2013, the project hosted a major research conference on the future of state charities regulation; those papers can be found [here](https://academiccommons.columbia.edu/search?f%5Bseries_ssim%5D%5B%5D=2013+Charities+Regulation+and+Oversight+Project+Policy+Conference). 
...
<li class="StepProgress-item is-done">
   ...
   <div>Legal compendium expanded with legal text of statutes provided by Teresa Harrison (Drexel University), with assistance from Jesse Lecy (Arizona State University) and NCCS.</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2025</div> 
   <div>Digitized legal compendium published.</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2024</div> 
   <div>Legal compendium updated to version 3.0.</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2024</div> 
...
<li class="StepProgress-item is-done">
   ...
   <div>Symposium: "Data and Technology: Resources and Implications for Nonprofit Regulation and Oversight."</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2019</div> 
   <div>Legal compendium updated (version 2).</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2016</div> 
   <div>Symposium: "State Regulation and Enforcement in the Charitable Sector."</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2016</div> 
   <div>"<em>Legal Compendium to the Regulation of Nonprofits and Philanthropy Project</em>" created and published.</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2015</div> 
   <div>Symposium: "Data Collection, Sharing, and Transparency in the Tax-Exempt Sector."</div>
</li>
<li class="StepProgress-item is-done">
   <div class="bold time">2015</div> 
   <div>Regulation of Nonprofits and Philanthropy Project launched at the Urban Institute under the leadership of Elizabeth T. Boris (Urban Institute) and Cindy M. Lott (Columbia University).</div>
</li>
...
> This [event](http://urban.org/sites/default/files/2021/03/25/final_agenda_-_cnp_regulations_jv_reordered3.pdf) focused on data and technologies state and federal charities regulators need to succeed in their oversight roles. Researchers, leaders from data-providing organizations, and state and federal charities regulators explored how to promote data-informed nonprofit regulation.
...
> In this [symposium](https://www.urban.org/events/state-regulation-and-enforcement-charitable-sector), participants discussed [*State Regulation and Enforcement in the Charitable Sector*](https://www.urban.org/research/publication/state-regulation-and-enforcement-charitable-sector), a report that provided a primer and road map on the state regulatory structures that oversee the charitable and nonprofit sector, toward the goal of more effective and efficient charity regulation. Topics included a summary and discussion of the report findings, the status of state charitable regulatory and enforcement activity, and next steps in formulating a research agenda.

**2015: Data Collection, Sharing, and Transparency in the Tax-Exempt Sector**

> The goals of [this convening](https://www.urban.org/events/regulation-nonprofits-and-philanthropy-project) were to discuss the ripple effects of regulatory changes regarding data collection, sharing, and transparency; discuss opportunities and challenges in the nonprofit sector resulting from these challenges; and explore inefficiencies and redundancies in data transfer that might be eliminated in the future among the sector’s stakeholders.
...
<div class="flow">
  {% include components/divider.html
    header = "Applications of the Framework and Related Research"
    style = "secondary" %}
</div>
<br>
...
<div class="flow">
  {% include components/divider.html
    header = "The Future of Nonprofit Regulation in the United States"
    style = "secondary" %}
</div>
