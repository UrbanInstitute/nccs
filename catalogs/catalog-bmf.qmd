...
s3://nccsdata/geocoding/bmf-master/merged/   # Superseded geocoded path — dual-published through the ADR 0039 window
...
s3://nccsdata/unified/bmf/state_marts/csv/   # Per-state geocoded marts
s3://nccsdata/master/bmf/state_marts/csv/    # Superseded marts path — dual-published through the ADR 0039 window
```
