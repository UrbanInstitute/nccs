...
paths <- get_core_paths( paths=d$Key, 
                         tscope="CHARITIES", 
                         fscope="PZ" )
download_urls  <- make_s3_urls( paths )
archive_urls <- make_archive_urls(
  paths, 
  base_url = nccs_legacy_base_url
)

BUTTONS  <- make_download_buttons( download_urls )
BUTTONS2 <- make_profile_buttons( archive_urls )
